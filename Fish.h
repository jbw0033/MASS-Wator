...
//Used to toggle output in Fish.h
...
//        MASS_base::log( "Fish BORN!!" );
 ...
 private:
  ...
  void *ravelledxy( void *argument );			//Get the ravelled xy coordinate of the fish, y-major #get-raveled-coordinate
