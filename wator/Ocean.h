...
public:
	...
	static const int NUM_NEIGHBORS = 4;									//A ocean has 4 neighbors
  ...
  /**
   * Initialize a Ocean object by allocating memory for it.
   */
...
private:
  ...
  void *popCount( void *argument );												//Return the population of this ocean
  void *recordAsNeighborPop();									//Record the inmessage to neighborPop
  void *resetForNextTurn();										//Reset for the next turn
  void *displayPopAsOut();										//Set the outmessage as population of this ocean
